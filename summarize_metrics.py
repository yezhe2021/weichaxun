...
def main():
    ...
    for path in Path(args.root).glob("**/metrics.json"):
        ...
        rows.append({
            ...
            "attn_cosine": summary.get("attn_cosine"),
            "teacher_ce": summary.get("teacher_ce"),
            "no_context_ce": summary.get("no_context_ce"),
            "patched_top1_match": summary.get("patched_top1_match"),
            "patched_top5_match": summary.get("patched_top5_match"),
            "patched_top10_match": summary.get("patched_top10_match"),
            "no_context_top1_match": summary.get("no_context_top1_match"),
            "no_context_top5_match": summary.get("no_context_top5_match"),
            "no_context_top10_match": summary.get("no_context_top10_match"),
