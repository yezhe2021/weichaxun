...
STAGES = ("prepare", "cache_llama", "cache_qwen", "teachers", "train_shared", "train_residual", "evaluate")
...
def execute(cfg, stage):
    if stage == "prepare":
        ...
        from experiment import evaluate, prepare_oracle_teachers, train_branch
...
def main():
    ...
    try:
        ...
        raise RuntimeError("Expanded residual A/B pipeline already running")
    ...
    print("ALL EXPANDED SHARED-VS-RESIDUAL EXPERIMENT STAGES COMPLETED", flush=True)
