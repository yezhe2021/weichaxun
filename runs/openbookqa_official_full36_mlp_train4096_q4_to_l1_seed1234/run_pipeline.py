...
def execute(cfg, stage):
    if stage == "model_audit":
        ...
        from data import cache_qwen
        cache_qwen(cfg)
    elif stage == "cache_llama":
        from data import cache_llama_and_pairs
        cache_llama_and_pairs(cfg)
...
def main():
    ...
    try:
        ...
        raise RuntimeError("Reverse Qwen-to-Llama pipeline already running")
    ...
    print("ALL REVERSE QWEN4-TO-LLAMA1 EXPERIMENT STAGES COMPLETED", flush=True)
