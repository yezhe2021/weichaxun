...
ROOT=/home/yezhe/伪查询/runs/p3d3_layer_aligned_native_query_reader_seed1234
...
prepare() {
  ...
  "${PY}" "${ROOT}/prepare_p3d3_data.py" --train "${HOTPOT}/hotpot_train_v1.1.json" --validation "${HOTPOT}/hotpot_dev_distractor_v1.json" --out "${ROOT}/data" --train-samples 64 --validation-samples 64 --seed 1234
}
