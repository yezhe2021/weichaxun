...
from train_p2f_writer import _resample_token_axis, value_mismatched_memory
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate one Qwen3.5-4B to Qwen3-8B P2-F Writer")
    ...
    for pair_index in tqdm(range(pair_count), desc=f"p2e_{writer_args['variant']}_free_running"):
        ...
        conditions = [
            ...
            ("writer_qwen35_4b_base", student_prefixed_prompt(tokenizer, base), writer_base, base["answer"], base["answer"], True, "accuracy"),
            ("writer_qwen35_4b_counterfactual", student_prefixed_prompt(tokenizer, base), writer_cf, counterfactual["answer"], counterfactual["answer"], True, "accuracy"),
            ("raw_minimal_qwen35_4b_base", student_prefixed_prompt(tokenizer, base), raw_base, base["answer"], base["answer"], True, "accuracy"),
            ("raw_minimal_qwen35_4b_counterfactual", student_prefixed_prompt(tokenizer, base), raw_cf, counterfactual["answer"], counterfactual["answer"], True, "accuracy"),
    ...
    writer_pc = paired_consistency(records, "writer_qwen35_4b_base", "writer_qwen35_4b_counterfactual")
    raw_pc = paired_consistency(records, "raw_minimal_qwen35_4b_base", "raw_minimal_qwen35_4b_counterfactual")
    native_em = source_em(conditions, "native_8b_base", "native_8b_counterfactual")
    writer_em = source_em(conditions, "writer_qwen35_4b_base", "writer_qwen35_4b_counterfactual")
    raw_em = source_em(conditions, "raw_minimal_qwen35_4b_base", "raw_minimal_qwen35_4b_counterfactual")
    paired_gap = paired_gap_bootstrap(
        records,
        "writer_qwen35_4b_base",
        "writer_qwen35_4b_counterfactual",
        "raw_minimal_qwen35_4b_base",
        "raw_minimal_qwen35_4b_counterfactual",
    )
    ...
    summary = {
        ...
        "paired_consistency": {
            "full_text": text_pc,
            "native_8b": native_pc,
            "writer_qwen35_4b": writer_pc,
            "raw_minimal_qwen35_4b": raw_pc,
        },
