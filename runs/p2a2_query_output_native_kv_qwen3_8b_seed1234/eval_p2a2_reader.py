...
class LazyPairCache:
    def __init__(self, index_path, capacity=2):
        ...
        if self.index.get("format_version") != 3:
            raise ValueError("P2-A2 evaluation requires format_version=3 pair cache")
...
def main():
    parser = argparse.ArgumentParser(description="Unified free-running evaluation for P2-A2")
