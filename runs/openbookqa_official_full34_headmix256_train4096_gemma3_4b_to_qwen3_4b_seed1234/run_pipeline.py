...
STAGES = (
    "model_audit", "prepare", "cache_gemma", "cache_qwen", "phase0_audit", "teachers", "baselines",
...
def execute(cfg, stage):
    ...
    elif stage == "cache_gemma":
        from data import cache_gemma
        cache_gemma(cfg)
...
def main():
    ...
    try:
        ...
        raise RuntimeError("Forward train4096 pipeline already running")
    ...
    print("ALL FORWARD TRAIN4096 EXPERIMENT STAGES COMPLETED", flush=True)
