...
def main():
    parser = argparse.ArgumentParser(description="Audit Qwen3-1.7B to Qwen3-8B P2-C2 compatibility")
    ...
    report = {
        ...
        "claim_scope": (
            "Enhanced Qwen3-1.7B sender-specific Writer into a frozen Qwen3-8B Reader-compatible "
