...
if __name__ == "__main__":
    ...
    module.to("cpu")
    x=torch.randn(1,28,32,8,128); y=torch.randn_like(x)
    ...
    assert sum(p.numel() for p in module.parameters())==7340032
    print("Reverse Residual64 identity/zero/bias/parameter tests passed",flush=True)
