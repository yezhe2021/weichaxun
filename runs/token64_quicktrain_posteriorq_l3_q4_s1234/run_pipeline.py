...
def append_results(cfg, comparison):
    ...
    section = "\n".join([
        ...
        f"## {tag}",
        "",
        "Machine-generated after successful completion. Quick 64-token Translator training pilot.",
        "",
...
def finalize(cfg):
    ...
    print("TOKEN64 QUICK-TRAIN EXPERIMENT COMPLETED", flush=True)
...
def main():
    ...
    try:
        ...
        raise RuntimeError("Token64 quick-train pipeline already running")
    ...
    print("ALL TOKEN64 QUICK-TRAIN STAGES COMPLETED", flush=True)
