...
def aggregate(records, num_layers):
...
def main():
    ...
    conditions, comparisons, layerwise, generation_rows, distribution_rows, cache_all, trace_all = aggregate(records, cfg["num_layers"])
