...
VARIANTS = (
    "task_only",
    "shared_span_relation",
)


def variant_features(variant):
    return {
        "shared_routing": variant == "shared_span_relation",
        "structure_loss": variant == "shared_span_relation",
    }
...
def main():
    parser = argparse.ArgumentParser(description="Train a Llama-3.2-3B to Qwen3-8B P2-E Writer")
