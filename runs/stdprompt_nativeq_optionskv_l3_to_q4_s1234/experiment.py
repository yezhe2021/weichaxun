...
def append_results_document(cfg, comparison):
    ...
    tag = "mmlupro_standardprompt_nativequestion_optionskv_rawanchor_full28_diagonal_llama3_2_3b_to_qwen3_4b_seed1234"
...
def finalize(cfg):
    ...
    comparison = {"experiment": "mmlupro_standardprompt_nativequestion_optionskv_rawanchor_full28_diagonal_llama3_2_3b_to_qwen3_4b_seed1234",
    ...
    log("STANDARD-PROMPT NATIVE-QUESTION OPTIONS-KV EXPERIMENT COMPLETED")
    return comparison
