...
def main():
    ...
    except BlockingIOError: raise RuntimeError("Posterior-Question Sender pipeline already running")
    ...
    print("ALL POSTERIOR-QUESTION SENDER EXPERIMENT STAGES COMPLETED", flush=True)
