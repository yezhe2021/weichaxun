...
Phase 1 trains four bias-free, K/V-independent architectures for 1024 optimizer steps
(8 true epochs over the same 1024-example training split):
...
Checkpoints every 128 steps through step 1024 are functionally evaluated on validation. Both minimum
